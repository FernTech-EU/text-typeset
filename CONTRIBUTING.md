# Contributing to text-typeset

Thank you for your interest in contributing to text-typeset! This document provides guidelines and information for contributors.
...
- Explain why this would be valuable for text-typeset users
...
By contributing to text-typeset, you agree that your contributions will be licensed under the [Mozilla Public License 2.0](LICENSE).
