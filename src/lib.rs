...
pub use types::{
    ...
    DecorationRect, FontFaceId, GlyphQuad, HitRegion, HitTestResult, ImageQuad, LaidOutSpan,
    LaidOutSpanKind, ParagraphResult, RenderFrame, SingleLineResult, TextFormat, UnderlineStyle,
    VerticalAlignment,
};
